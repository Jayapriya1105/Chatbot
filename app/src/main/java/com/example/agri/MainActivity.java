...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page06);
    ...
    void callAPI(String question){
        ...
        Request request=new Request.Builder()
                ...
                .header("Authorization","Bearer sk-tsq7O0GlLGZKviZKhbfpnx4FptNMt1q64YDmzZM-zxT3BlbkFJN5twR9ppolMmCK6NNAq-uAa_2YpvREfCLEN5DXHogA")
                .post(body)
                .build();
                                            ...
                                            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                                                ...
                                                } else
                                                {
                                                    try {
                                                        ...
                                                        {
                                                            addResponse("Failed: " + responseData);
                                                        }
                                                    } catch (JSONException e) {
                                                        addResponse("Failed to load response: " + responseData);
                                                    }
